          ...
          <div className="overflow-hidden transition-all transform">
            <h3 className="text-center text-lg font-medium leading-6">
              <div className="flex flex-col justify-center items-center space-y-4">
                <MailOpenIcon className="w-12 h-12 shrink-0 text-green-500" />
              </div>
                ...
                <div className="px-4 sm:px-12">
                  <div className="flex justify-center">
                    <Link href="/">
                      <a className="flex items-center space-x-1">
                        <SparklesIcon className="shrink-0 w-8 h-8 text-green-500" />
                  ...
                  {!showSignIn ? (
                    <Dialog.Description className="mt-2 text-gray-500 text-base text-center">
                      Please create an account to list your room or beome a roomie.
                    </Dialog.Description>
                  ) : null}
                      ...
                      {({ isSubmitting, isValid, values, resetForm }) => (
                        <Form className="mt-4">
                          ...
                          <button
                            ...
                            className="mt-6 w-full bg-green-600 text-white py-2 px-8 rounded-md focus:outline-none focus:ring-4 focus:ring-green-600 focus:ring-opacity-50 hover:bg-green-500 transition disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-green-600"
                          >
                            {isSubmitting
                              ? 'Loading...'
                            ...
                            {showSignIn ? (
                              <>
                                ...
                                <button
                                  ...
                                  className="underline underline-offset-1 font-semibold text-green-500 hover:text-green-600 disabled:hover:text-green-500 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                  Sign up
                                </button>
                                .
